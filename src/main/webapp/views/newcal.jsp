...
<title>jQuery mtz.monthpicker Demos</title>
<link rel="stylesheet" href="http://localhost:8080/jobpluslearn/styles/jquerysctipttop.css" />
<link rel="stylesheet" href="http://localhost:8080/jobpluslearn/styles/smoothness.css" />
<spring:url value="/scripts/jpl-cal1.js" var="jplcal1Js" />

<link href="${jqueryuiCss}" rel="stylesheet" />

<spring:url value="/scripts/jquery-1.10.2.js" var="jqueryJs" />
<script src="${jplcal1Js}"></script>
...
<ul>
<li><a href="http://www.jqueryscript.net/time-clock/jQuery-Plugin-For-jQuery-UI-Month-Year-Picker-mtz-monthpicker.html">Download This Plugin</a></li>
...
<h1 style="margin-top:150px;">jQuery mtz.monthpicker Demos</h1>
<h2>Basic</h2>
